...
RUN apt-get update -y && apt-get install -y netcat apt-utils git nodejs npm php5-curl && apt-get clean && \
    mkdir ${EBOT_HOME} && \
    ...
    git clone https://github.com/lockgar/eBot-CSGO.git "$EBOT_HOME" && \
